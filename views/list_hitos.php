        ...
        <div class="row mb-3">
            <div class="col-3">
                <form action="buscar.php" method="GET">
                    ...
                    <a href="../views/full-width.php?frame=list_contratos_anio.php&gr_sel=hito" class="btn btn-secondary">AÑADIR</a>
                    </div>
                </form>
        </div>
    </div>
        ...
        <ul>
            ...
            if(isset($_GET['pagina'])){
                for ($i=1; $i <= $total_paginas ; $i++) { 
                    ...
                    {
                        echo "<li><a href='?pagina=$i&group=".$_SESSION["group_hito"]."' class='m-2'>$i</a></li>";
                    }
                }
            }else
            {
