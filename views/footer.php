  ...
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_quarter last">
      ...
      <ul class="nospace linklist">
        <li>
          <article>
            <p class="nospace">Mediante Correo Electronico:</p>
            <h6 class="nospace font-x1"><a href="#">propuestowps@gmail.com</a></h6>
          </article>
        </li>
      </ul>
    </div>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <p class="fl_left">Copyright &copy; 2018 - All Rights Reserved - <a href="#">INFRA</a></p>
