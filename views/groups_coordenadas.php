...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="content">
        ...
        <div class="row mb-3">
            <div class="col-3">
                <a href="../views/full-width.php?frame=list_contratos.php&select=coordenada" class="btn btn-secondary">AÑADIR</a>   
            </div>
        </div>
    <div class="row">
        <div class="col">
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="excel_coordenadas.php?group=<?php echo $line['group_coordenadas_fk']?>" class="btn btn-dark">
                    Editar
                    </a>
                    <a href="excel_coordenadas.php?group=<?php echo $line['group_coordenadas_fk']?>" class="btn-danger">
                    Eliminar
                    </a>
                    <!-- 
